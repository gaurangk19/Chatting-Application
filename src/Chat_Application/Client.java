...
public class Client implements ActionListener{
	...
	Client(){
		...
		ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icons/client.png")); //profile image
		Image i5 = i4.getImage().getScaledInstance(45, 50, Image.SCALE_DEFAULT);
	...
	public static void main(String[] args) {		
		...
		try {
			Socket s = new Socket("127.0.0.1", 6001); //(local host, port number)
